...
namespace CustomControls_TitledLabel {
    ...
    public class XrTitledLabel : XRControl {
        ...
        protected override void SerializeProperties(XRSerializer serializer) {
            ...
            serializer.SerializeString("TitleText", titleText, "");
            serializer.SerializeFont("TitleFont", this.TitleFont);
            serializer.SerializeBoolean("DisplayTitle", this.DisplayTitle);
            serializer.SerializeEnum("ContextTextAlignment", this.ContextTextAlignment);
            serializer.SerializeEnum("TitleTextAlignment", this.TitleTextAlignment);
        }

        protected override void DeserializeProperties(XRSerializer serializer) {
            base.DeserializeProperties(serializer);
            this.TitleText = serializer.DeserializeString("TitleText", "");
            Font defaultFont = new Font("Times New Roman", 6.75F, FontStyle.Regular, GraphicsUnit.Point, ((Byte)(0)));
            this.TitleFont = serializer.DeserializeFont("TitleFont", defaultFont);
            this.DisplayTitle = serializer.DeserializeBoolean("DisplayTitle", true);
            this.ContextTextAlignment = (ContextTextAlignmentEnum)serializer.DeserializeEnum("ContextTextAlignment", typeof(ContextTextAlignmentEnum), ContextTextAlignmentEnum.BelowTitleText);
            this.TitleTextAlignment = (TitleTextAlignmentEnum)serializer.DeserializeEnum("TitleTextAlignment", typeof(TitleTextAlignmentEnum), TitleTextAlignmentEnum.TopLeft);
        }
